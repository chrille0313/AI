...
class Snake:
	def __init__(self, pos=(0, 0), dir=Directions.RIGHT, length=3):
		self.pos = pos
		self.dir = dir
		self.length = length
	...
	def turn_right(self):
		self.dir = Directions.get_next_direction(self.dir, right=True)

	def turn_left(self):
		self.dir = Directions.get_next_direction(self.dir, right=False)
